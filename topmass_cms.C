{
//=========Macro generated from canvas: topmass_cms/topmass_cms
//=========  (Tue Sep 15 04:10:04 2015) by ROOT version5.32/04
   ...
   gre->SetPoint(4,172.29,1);
   gre->SetPointError(4,2.905942,0.0001);
   ...
   gre->SetPoint(4,172.29,1);
   gre->SetPointError(4,1.17,0.0001);
   gre->SetPoint(5,174.34,0.15);
   ...
   pl = new TPaveLabel(0.07,0.3640034,0.5,0.4140034,"CMS 2012, b-energy peak","brNDC");
   pl->SetBorderSize(0);
   pl->SetFillStyle(0);
   pl->SetTextAlign(12);
   ...
   pl = new TPaveLabel(0.07,0.3440034,0.5,0.3940034,"This analysis, 19.7 fb^{-1}","brNDC");
   pl->SetBorderSize(0);
   pl->SetFillStyle(0);
   pl->SetTextAlign(12);
   ...
   pl = new TPaveLabel(0.63,0.3640034,0.93,0.4140034,"172.29 #pm 1.17 #pm 2.66 GeV","brNDC");
   pl->SetBorderSize(0);
   pl->SetFillStyle(0);
   pl->SetTextAlign(12);
   ...
   //   pl = new TPaveLabel(0.07,0.1377922,0.5,0.1877922,"ATLAS, CDF, CMS, D0","brNDC");
